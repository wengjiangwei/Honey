...
if __name__ == '__main__':
    img_path = r'E:\Data\Temp\fake\JPEGImages'  # 图片文件夹路径
    xml_path = r'E:\Data\Temp\fake\Annotations'  # xml标注文件夹路径
    img_write_path = r'E:\Data\Temp\fake\JPEGImages_aug'  # 翻转后的图片保存路径
    xml_write_path = r'E:\Data\Temp\fake\Annotations_aug'   # 修改后的xml标注保存路径
